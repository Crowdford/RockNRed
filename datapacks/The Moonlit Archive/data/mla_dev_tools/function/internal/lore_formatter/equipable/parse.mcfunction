...
scoreboard players set $valid bbl.main 0
execute store success score $valid bbl.main if score $slot_flag bbl.main >= $64 bbl.constant run scoreboard players remove $slot_flag bbl.main 128
execute if score $valid bbl.main matches 1 run tag @s add equip.mainhand
scoreboard players set $valid bbl.main 0
execute store success score $valid bbl.main if score $slot_flag bbl.main >= $64 bbl.constant run scoreboard players remove $slot_flag bbl.main 256
