...
data modify storage bb:lib sudo_root.parsing.wrapper_input set from storage t:e m.p.1
function bb:internal/systems/string_manip/line_wrapper/start
execute if data storage bb:lib sudo_root.parsing.wrapper_array.12.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.12.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.11.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.11.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.10.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.10.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.9.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.9.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.8.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.8.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.7.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.7.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.6.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.6.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.5.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.5.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.4.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.4.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.3.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.3.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.2.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.2.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.1.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.1.string
execute if data storage bb:lib sudo_root.parsing.wrapper_array.0.string run data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append from storage bb:lib sudo_root.parsing.wrapper_array.0.string
