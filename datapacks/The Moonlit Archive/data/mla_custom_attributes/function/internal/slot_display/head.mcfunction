...
$data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append value [{"color":"#C90A30","italic":false,"translate":"oneshot.item.meta.stat.max_hp"},{"color":"gray","italic":false,"text":": $(current_hp)/$(max_hp)"}]
...
#data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append value [{text:" "}]
#data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append value [{"color":"#5E5E5E","italic":true,"translate":"oneshot.item.meta.stat.warning.0"}]
#data modify block 10000000 1 10000000 Items[0].components."minecraft:lore" append value [{"color":"#5E5E5E","italic":true,"translate":"oneshot.item.meta.stat.warning.1"}]
