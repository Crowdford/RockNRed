...
execute as @p[advancements={mla_main:interact/right=true}] if data entity @s SelectedItem.components."minecraft:custom_data".mla_mb run function mla_map_exclusive:internal/tiny_block/placeon_raycast/start
