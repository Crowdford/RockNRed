...
execute if score $module_enabled.custom_attributes mla.main matches 0 run item replace entity @s armor.head with clock[item_model="mla:survival/gui/slot_icons/empty",equippable={slot:"head",equip_sound:"block.candle.ambient",swappable:false,damage_on_hurt:false},enchantments={"minecraft:binding_curse":1,"minecraft:vanishing_curse":1},max_stack_size=1,custom_data={a:1},tooltip_display={hide_tooltip:true}] 1
execute if score $module_enabled.oneshot mla.main matches 0 run item replace entity @s armor.chest with clock[item_model="mla:survival/gui/slot_icons/empty",equippable={slot:"chest",equip_sound:"block.candle.ambient",swappable:false,damage_on_hurt:false},enchantments={"minecraft:binding_curse":1,"minecraft:vanishing_curse":1},max_stack_size=1,custom_data={a:1},tooltip_display={hide_tooltip:true}] 1
execute if score $module_enabled.survival mla.main matches 0 run item replace entity @s armor.legs with clock[item_model="mla:survival/gui/slot_icons/empty",equippable={slot:"legs",equip_sound:"block.candle.ambient",swappable:false,damage_on_hurt:false},enchantments={"minecraft:binding_curse":1,"minecraft:vanishing_curse":1},max_stack_size=1,custom_data={a:1},tooltip_display={hide_tooltip:true}] 1
execute if score $module_enabled.custom_attributes mla.main matches 0 run item replace entity @s armor.feet with clock[item_model="mla:survival/gui/slot_icons/empty",equippable={slot:"feet",equip_sound:"block.candle.ambient",swappable:false,damage_on_hurt:false},enchantments={"minecraft:binding_curse":1,"minecraft:vanishing_curse":1},max_stack_size=1,custom_data={a:1},tooltip_display={hide_tooltip:true}] 1
...
function mla_trinkets:internal/slot_display/update_inv_display
