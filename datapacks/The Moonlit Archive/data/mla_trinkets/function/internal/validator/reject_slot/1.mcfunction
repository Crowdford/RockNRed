...
execute store result score $slot_flag bbl.main run data get entity @s Inventory[{Slot:9b}].components."minecraft:custom_data".mla_trinkets_data.slots
function mla_trinkets:internal/validator/check
execute if entity @s[tag=!valid] run function bb:internal/systems/drop/checked/9
