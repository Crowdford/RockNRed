...
execute if data block 10000000 1 10000000 Items[0] run item replace entity @s inventory.1 from block 10000000 1 10000000 container.0

execute store result score $slot_flag bbl.main run data get entity @s Inventory[{Slot:10b}].components."minecraft:custom_data".mla_trinkets_data.slots
function mla_trinkets:internal/validator/check
execute if entity @s[tag=!valid] run function bb:internal/systems/drop/checked/10
