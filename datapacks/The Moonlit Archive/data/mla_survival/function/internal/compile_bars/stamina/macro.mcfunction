...
$data modify storage bbl:concat sudo_root.array append string storage mla:survival sudo_root.prebuilt.hud.bars.stamina.void $(index_normal) 60
...
$data modify storage bbl:concat sudo_root.array append string storage mla:survival sudo_root.prebuilt.hud.bars.stamina.void $(index_flash) 60
