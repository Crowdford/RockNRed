...
#Forceload chunk.
forceload add 10000000 10000000
...
scoreboard objectives add bbl.main dummy
#\Constants
...
scoreboard objectives add bbl.inventory dummy

#Init
#\Next ID
execute unless score $next_id bbl.main matches -2147483647..2147483647 run scoreboard players set $next_id bbl.main 1
#\Config
##\No iframes
execute unless score $bbl.config.no_iframes bbl.main matches -2147483647..2147483647 run scoreboard players set $bbl.config.no_iframes bbl.main 0
#\Activve enderchest id
execute unless score $bbl.universal_active_enderchest.menu_id bbl.main matches -2147483647..2147483647 run scoreboard players set $bbl.universal_active_enderchest.menu_id bbl.main 1
...
scoreboard players set $16 bbl.constant 16
...
scoreboard players set $32 bbl.constant 32
...
scoreboard players set $64 bbl.constant 64
...
scoreboard players set $128 bbl.constant 128
...
scoreboard players set $256 bbl.constant 256
...
#\Working shulker
function bb:internal/datapack_handling/reset_shulker
